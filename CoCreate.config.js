module.exports = {
	...
	sources: [
		{
			...
			object: {
				...
				"contenteditable-demo":
					"{{./demo/elements/contenteditable.html}}",
	...
	modules: {
		...
		file: {
			...
			selector:
				"[type='file'], [actions*='upload'], [actions*='download'], [actions*='saveLocally'], [actions*='import'], [actions*='export'], [actions*='createFile'], [actions*='deleteFile'], [actions*='createDirectory'], [actions*='deleteDirectory']"
		},
		elements: {
		...
		dnd: {
			import: "@cocreate/dnd",
			selector:
				"[sortable], [cloneables], [draggable], [droppable], [cloneable]"
		},
		position: {
		...
		users: {
			...
			selector:
				"[session], [actions*='signUp'], [actions*='signIn'], [actions*='signOut'], [user-status]"
		},
		unique: {
		...
		industry: {
			...
			selector:
				"[actions*='createIndustry'], [actions*='runIndustry'], [actions*='deleteIndustry'], [actions*='deleteIndustries']"
		},
		uuid: {
		...
		"rich-text": {
			...
			selector:
				"[actions*='nodeName'], [actions*='cloneElement'], [actions*='deleteElement'], [node-name]"
		},
		codearea: {
