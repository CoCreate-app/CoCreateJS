...
lazyLoad('render', '[render], [render-selector], [render-closest], [render-parent], [render-next], [render-previous], [template], template', () => import(/*webpackChunkName: "render-chunk"*/ '@cocreate/render'));
